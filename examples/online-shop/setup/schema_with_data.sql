...
REM INSERTING into balUser.PURCHASE
SET DEFINE OFF;
Insert into balUser.PURCHASES (PURCHASE_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,PURCHASE_DATE) values (1,1,'Canceled',56,to_date('10-OCT-16','DD-MON-RR'));
Insert into balUser.PURCHASES (PURCHASE_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,PURCHASE_DATE) values (2,2,'Shipped',57,to_date('02-OCT-16','DD-MON-RR'));
Insert into balUser.PURCHASES (PURCHASE_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,PURCHASE_DATE) values (3,3,'Pending',58,to_date('02-OCT-16','DD-MON-RR'));
Insert into balUser.PURCHASES (PURCHASE_ID,CUSTOMER_ID,STATUS,SALESMAN_ID,PURCHASE_DATE) values (4,1,'Shipped',58,to_date('02-OCT-16','DD-MON-RR'));

REM INSERTING into balUser.PURCHASE_ITEMS
SET DEFINE OFF;
Insert into balUser.PURCHASE_ITEMS (PURCHASE_ID,ITEM_ID,PRODUCT_ID,QUANTITY,UNIT_PRICE,WARRANTY_PERIOD) values (2,1,1,116,3410.99,INTERVAL '5' YEAR);
Insert into balUser.PURCHASE_ITEMS (PURCHASE_ID,ITEM_ID,PRODUCT_ID,QUANTITY,UNIT_PRICE,WARRANTY_PERIOD) values (1,1,10,77,2200,INTERVAL '3-6' YEAR TO MONTH);
Insert into balUser.PURCHASE_ITEMS (PURCHASE_ID,ITEM_ID,PRODUCT_ID,QUANTITY,UNIT_PRICE,WARRANTY_PERIOD) values (2,2,3,65,2670.99,INTERVAL '5' YEAR);
Insert into balUser.PURCHASE_ITEMS (PURCHASE_ID,ITEM_ID,PRODUCT_ID,QUANTITY,UNIT_PRICE,WARRANTY_PERIOD) values (4,1,4,45,2550.99,INTERVAL '5' YEAR);
Insert into balUser.PURCHASE_ITEMS (PURCHASE_ID,ITEM_ID,PRODUCT_ID,QUANTITY,UNIT_PRICE,WARRANTY_PERIOD) values (4,2,5,70,2500.98,INTERVAL '5' YEAR);
Insert into balUser.PURCHASE_ITEMS (PURCHASE_ID,ITEM_ID,PRODUCT_ID,QUANTITY,UNIT_PRICE,WARRANTY_PERIOD) values (3,1,9,123,2259.99,INTERVAL '6' MONTH);
