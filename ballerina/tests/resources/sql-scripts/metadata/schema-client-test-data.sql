...
CREATE OR REPLACE PROCEDURE getEmpsName(EMPNUMBER IN NUMBER, FNAME OUT VARCHAR2) AS
BEGIN
...
CREATE OR REPLACE PROCEDURE getEmpsEmail(EMPNUMBER IN NUMBER, EMPEMAIL OUT VARCHAR2) AS
BEGIN
