...
isolated function beforeQueryWithSimpleParamsFunc() returns sql:Error? {
    ...
    result = check dropTableIfExists("NumericSimpleQueryTable", oracledbClient);
    ...
    result = check dropTableIfExists("CharSimpleQueryTable", oracledbClient);
    ...
    result = check dropTableIfExists("AnsiSimpleQueryTable", oracledbClient);
    ...
    result = check dropTableIfExists("SqlDsSimpleQueryTable", oracledbClient);
    ...
    result = check dropTableIfExists("LobSimpleQueryTable", oracledbClient);
