BEGIN
EXECUTE IMMEDIATE 'DROP TABLE ' || 'GeneralQueryTable';
EXCEPTION
WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
        RAISE;
...
BEGIN
EXECUTE IMMEDIATE 'DROP TABLE ' || 'NumericSimpleQueryTable';
EXCEPTION
WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
        RAISE;
...
BEGIN
EXECUTE IMMEDIATE 'DROP TABLE ' || 'CharSimpleQueryTable';
EXCEPTION
WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
        RAISE;
...
BEGIN
EXECUTE IMMEDIATE 'DROP TABLE ' || 'AnsiSimpleQueryTable';
EXCEPTION
WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
        RAISE;
...
BEGIN
EXECUTE IMMEDIATE 'DROP TABLE ' || 'SqlDsSimpleQueryTable';
EXCEPTION
WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
        RAISE;
...
BEGIN
EXECUTE IMMEDIATE 'DROP TABLE ' || 'LobSimpleQueryTable';
EXCEPTION
WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
        RAISE;
